 ...
 * but we must override setScale, as both radial and angular axes
 ...
 *   - t2g (in updateAngularAxis) 'tick' labels (in degrees) -> 'geometric' radians
 * + for category axes:
 *   - d2c (in calc) just like for cartesian axes
 *   - c2g (in plot) category indices -> 'geometric' radians
 *   - t2g (in updateAngularAxis) 'tick' labels (as category indices) -> 'geometric' radians
 *
